...
class alfie_wp_weather_widget extends WP_Widget
{
    ...
    function form( $instance )
    {
        ...
        <div class="widget-controls">
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'alfie_wp_weather' ); ?></label>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'woeid' ); ?>"><?php _e( 'WOEID:', 'alfie_wp_weather' ); ?></label>
                <input type="text" class="widefat alfie-woeid" id="<?php echo $this->get_field_id( 'woeid' ); ?>"
                       name="<?php echo $this->get_field_name( 'woeid' ); ?>"
                       value="<?php echo esc_attr( $instance['woeid'] ); ?>"/>
            </p>

            <div id="location-search">
                <div id="location-input">
                    <label
                        for="<?php echo $this->get_field_id( 'city' ); ?>"><?php _e( 'Search for a location:', 'alfie_wp_weather' ); ?></label>
                    <input autocomplete="off" class="widefat" type="text" id="search-location" name="search-location"/>
                </div>
                <a id="search_woeid"
                   class="button button-primary fullwidth aligncenter mb20"><?php _e( 'Click to search location', 'alfie_wp_weather' ); ?></a>
            ...
            <p>
                <label
                    for="<?php echo $this->get_field_id( 'alfie_wp_weather_temperature' ); ?>"><?php _e( 'Temperature', 'alfie_wp_weather' ) ?></label>
